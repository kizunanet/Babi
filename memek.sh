...
# domain random
CDN="https://raw.githubusercontent.com/kizunanet/Babi/main/ssh"
cd /root
if [ "${EUID}" -ne 0 ]; then
...
echo ""
wget -q https://raw.githubusercontent.com/kizunanet/Babi/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
echo " "
clear
...
sleep 3
clear
wget https://raw.githubusercontent.com/kizunanet/Babi/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
wget https://raw.githubusercontent.com/kizunanet/Babi/main/ssh/ins-udp && chmod +x ins-udp && ./ins-udp
clear
echo -e "\e[33m===================================\033[0m"
...
sleep 3
clear
wget https://raw.githubusercontent.com/kizunanet/Babi/main/backup/set-br.sh &&  chmod +x set-br.sh && ./set-br.sh
clear
clear
echo -e "\e[33m===================================\033[0m"
...
sleep 3
clear
wget https://raw.githubusercontent.com/kizunanet/Babi/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/kizunanet/Babi/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
echo -e "\e[33m===================================\033[0m"
...
sleep 3
clear
wget -q -O slow.sh https://raw.githubusercontent.com/kizunanet/Babi/main/slow.sh && chmod +x slow.sh && ./slow.sh
clear
cat> /root/.profile << END
if [ "$BASH" ]; then
if [ -f ~/.bashrc ]; then
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/kizunanet/Babi/main/version  )
